...
const (
	...
	CHAT_WIDTH   = 10
	CHAT_HEIGHT  = 14
	CHAT_START_X = 31 - CHAT_WIDTH
	CHAT_START_Y = 1

	GROUP_START_X = 1
	GROUP_START_Y = 4
	GROUP_WIDTH   = 7
	GROUP_HEIGHT  = 10 - GROUP_START_Y

	INSPECT_START_X = 1
	INSPECT_START_Y = GROUP_START_Y + GROUP_HEIGHT
	INSPECT_WIDTH   = 7
	INSPECT_HEIGHT  = 17 - INSPECT_START_Y

	TALK_START_X = 6
	TALK_START_Y = 12
	TALK_WIDTH   = 20
	TALK_HEIGHT  = 16.5 - TALK_START_Y
