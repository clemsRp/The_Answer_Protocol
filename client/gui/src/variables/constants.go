...
const (
	...
	COMBAT_CHAT_START_X = CHAT_START_X
	COMBAT_CHAT_END_X   = CHAT_START_X + CHAT_WIDTH - 2

	COMBAT_LEFT_END_X      = COMBAT_CHAT_START_X
	COMBAT_FIGHTERS_END_Y  = 10
	COMBAT_ACTIONS_START_Y = COMBAT_FIGHTERS_END_Y
